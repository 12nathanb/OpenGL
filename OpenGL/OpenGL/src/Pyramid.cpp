...
Pyramid::Pyramid(std::string name, std::string filename)
{
	...
	Vertex vertices[] =
	{
		//Position								//Color							//Texcoords					//Normals
				...
				//Triangle left
				glm::vec3(0.f, 0.5f, 0.f),				glm::vec3(1.f, 1.f, 1.f),		glm::vec2(0.5f, 1.f),		glm::vec3(-1.f, 0.f, 0.f),
				glm::vec3(-0.5f, -0.5f, -0.5f),			glm::vec3(1.f, 1.f, 1.f),		glm::vec2(0.f, 0.f),		glm::vec3(-1.f, 0.f, 0.f),
				glm::vec3(-0.5f, -0.5f, 0.5f),			glm::vec3(1.f, 1.f, 1.f),		glm::vec2(1.f, 0.f),		glm::vec3(-1.f, 0.f, 0.f),
